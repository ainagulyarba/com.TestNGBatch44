...
WebElement filesesButtonu=driver.findElement(By.id("file-upload"));
        ...
        String dosyaYolu=System.getProperty("user.home")+"\\Desktop\\Deneme\\selenium.xlsx";
         // 3- sendKeys() ile dinamik path'i dosya sec butonunua yollayalim
    filesesButtonu.sendKeys(dosyaYolu);
